...
Credenciales: por variables de entorno (Waykee Secrets markers en bash). NO hardcodear.
  SANIMEX_CAR_HOST / SANIMEX_CAR_PORT / SANIMEX_CAR_USER / SANIMEX_CAR_PASS (cron: ~/.config/comprasai/hana.env)

Uso:
  SANIMEX_CAR_HOST=.. SANIMEX_CAR_PORT=.. SANIMEX_CAR_USER=.. SANIMEX_CAR_PASS=.. python3 build_kardex_v3.py <v2_db_in> <v3_db_out>
"""
...
BUDAT_DESDE = ventana.fecha_desde_movimientos()  # 24 meses + 1 de colchon, diseno aprobado T20
