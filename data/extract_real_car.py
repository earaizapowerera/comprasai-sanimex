...
import ventana  # noqa: E402  (ventana móvil común a todos los extractores)

MES_FIN = ventana.mes_fin()        # mes en curso (parcial)
MES_INICIO = ventana.mes_inicio()  # 24 meses contando MES_FIN
