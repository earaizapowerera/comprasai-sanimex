...
Credenciales: por variables de entorno (Waykee Secrets markers en bash). NO hardcodear.
  SANIMEX_CAR_HOST / SANIMEX_CAR_PORT / SANIMEX_CAR_USER / SANIMEX_CAR_PASS (Waykee Secrets en el cron: ~/.config/comprasai/hana.env)

Uso:
  SANIMEX_CAR_HOST=.. (etc.) python3 build_leadtimes.py <v3_db_in> <v4_db_out>
"""
...
BEDAT_DESDE = ventana.fecha_desde_movimientos()  # pedidos de los ultimos 24 meses + 1
